...
Users API: https://documenter.getpostman.com/view/40123473/2sAYX5KhRK
Cards API: https://documenter.getpostman.com/view/40123473/2sAYX5KhVj
...
1. Clone the repository:
   ```bash
   git clone <https://github.com/DeadlyMelody/nodeFinalProject>
   ```
...
When updating a nested object (e.g., name), you must send the entire object, not just the changed field. make sure if there are any required fields.
...
## Contact
For questions or contributions, please contact [DeadlyMelody on github].